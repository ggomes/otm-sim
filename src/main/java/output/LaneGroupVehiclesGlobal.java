...
public class LaneGroupVehiclesGlobal extends AbstractOutputTimedLanegroup {
    ...
    public LaneGroupVehiclesGlobal(Scenario scenario, String prefix, String output_folder, List<Long> link_ids, Float outDt) throws OTMException {
        ...
        if(write_to_file){
            ...
            try {
                ...
                for(AbstractLaneGroup lg : lanegroups){
                    ...
                    isfirst = false;
                    writer.write(String.format("%f",lg.vehicles_for_commodity(null)));
                }
                writer.write("\n");
            } catch (IOException e) {
            ...
            for(AbstractLaneGroup lg : lanegroups)
                vehicles.get(lg.id).add(lg.vehicles_for_commodity(null));
        }
    }
